...
if ($stashable) {
    $attributes = $attributes->merge([
        ...
        'x-init' => '$el.classList.add(\'ltr:-translate-x-full\'); $el.classList.add(\'rtl:translate-x-full\'); $el.removeAttribute(\'data-mobile-cloak\'); $el.classList.add(\'transition-transform\')',
    ])->class([
        'max-lg:data-mobile-cloak:hidden',
        'ltr:[[data-show-stashed-sidebar]_&]:translate-x-0! rtl:[[data-show-stashed-sidebar]_&]:-translate-x-0! ltr:lg:translate-x-0! rtl:lg:-translate-x-0!',
